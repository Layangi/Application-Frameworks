...
* Harden MessageHandler in LabServer.js to avoid issues where we cannot find a callback for an operation.
...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and LabServer.js
...
* Correctly emit errors from LabServer.js only wrapping errors that are strings
